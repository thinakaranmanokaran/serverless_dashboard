      ...
      >
        ...
        <div className="mb-10 text-center">
          <div className="w-12 h-12 rounded-2xl bg-black flex items-center justify-center mx-auto mb-5 overflow-hidden">
            <img src="/logo.png" alt="RemoteConfig" className="w-8 h-8 object-contain invert" onError={(e) => {
        ...
        <AnimatePresence>
          {error && (
            ...
            >
              ...
              <button onClick={clearError} className="p-1 rounded-full hover:bg-red-100 transition-colors">
        ...
        <div className="border border-[#e5e5e5] rounded-3xl overflow-hidden">
          <form onSubmit={handleSubmit} className="p-8 space-y-5">
            <div>
              <label className="caption text-[#737373] block mb-2">
                Personal Access Token
              </label>
              <div className="relative">
                <Key className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#737373]" />
                <input
