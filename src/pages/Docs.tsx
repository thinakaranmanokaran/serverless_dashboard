...
const TipBox = ({ children }: { children: React.ReactNode }) => (
  <div className="flex gap-3 p-4 rounded-2xl bg-[#f5f5f5] text-sm leading-relaxed" style={{ fontFamily: 'DM Sans, sans-serif', fontWeight: 320 }}>
    <Lightbulb className="w-4 h-4 text-black shrink-0 mt-0.5" aria-hidden="true" />
    <span>{children}</span>
  </div>
);
...
const howToSchema = {
  ...
  "@type": "HowTo",
  "name": "How to Create a GitHub Personal Access Token for Serverless Dashboard",
  "description": "Step-by-step guide to generating a GitHub PAT (Classic) to authorize Serverless Dashboard in under 5 minutes.",
  "totalTime": "PT5M",
  "step": [
    ...
    { "@type": "HowToStep", "position": 8, "name": "Copy & paste your token", "text": "Click Generate token, copy it immediately (shown once), and paste into Serverless Dashboard Authorization." }
  ]
};
...
const breadcrumbSchema = {
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://thinakaranmanokaran.github.io/serverless_dashboard/" },
    { "@type": "ListItem", "position": 2, "name": "Documentation", "item": "https://thinakaranmanokaran.github.io/serverless_dashboard/docs" }
  ]
};
...
export function Docs() {
  return (
    <>
      <SEO
        title="Setup Guide - Connect GitHub with a Personal Access Token"
        description="Step-by-step guide to creating a GitHub Personal Access Token for Serverless Dashboard. Learn how to authorize, set scopes, and start managing configs in 5 minutes."
        keywords="github personal access token, github pat, Serverless Dashboardashboard setup, github token guide, github authorization, token scopes, repo scope, developer settings"
        canonical="/docs"
        ogType="article"
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <section className="py-20">
          ...
          <p className="body-lg text-[#3d3d3d]" style={{ fontWeight: 330 }}>
            You need a <strong style={{ fontWeight: 540 }}>GitHub Personal Access Token</strong> to authorize Serverless Dashboard.
        ...
        <section className="color-block color-block-lime section-gap max-w-5xl mx-auto" aria-labelledby="step-by-step-heading">
          <div>
            <div className="flex items-center gap-3 mb-10">
              <div className="w-9 h-9 rounded-xl bg-black flex items-center justify-center">
                <Key className="w-4 h-4 text-white" aria-hidden="true" />
              </div>
              <h2 id="step-by-step-heading" className="headline text-black" style={{ fontSize: 22 }}>GitHub Token - Step by Step</h2>
            </div>
            ...
            <div className="bg-white/70 rounded-2xl p-6 mb-12 border border-black/10">
              ...
              <p className="body-sm text-black/70 leading-relaxed" style={{ fontWeight: 320 }}>
                ...
                <a href="https://github.com/join" target="_blank" rel="noopener noreferrer" className="text-black font-semibold hover:underline inline-flex items-center gap-1">
                  Sign up at github.com <ExternalLink className="w-3 h-3" aria-hidden="true" />
                </a>.{' '}
            ...
            <div className="space-y-16">
              {[
                ...
                },
                {
                  ...
                  body: <>Expand <strong style={{ fontWeight: 540 }}>Personal access tokens</strong>, then click <strong style={{ fontWeight: 540 }}>Tokens (classic)</strong>. Classic tokens have the best compatibility for tools like Serverless Dashboard.</>,
                ...
                },
                {
                  ...
                  body: <>In the <strong style={{ fontWeight: 540 }}>Note</strong> field, enter something like <code className="bg-black/10 px-1.5 py-0.5 rounded text-xs font-mono">Serverless Dashboardashboard Access</code>. Then set <strong style={{ fontWeight: 540 }}>Expiration</strong> - we recommend <em>90 days</em>.</>,
                  ...
                  <div className="bg-white/70 rounded-2xl p-5 border border-black/10">
                    <div className="flex items-center gap-2.5 mb-3">
                      <div className="w-8 h-8 rounded-lg bg-black/10 flex items-center justify-center">
                        <GitBranch className="w-4 h-4 text-black" aria-hidden="true" />
                      </div>
                      <div>
                    ...
                    <p className="body-sm text-black/60 leading-relaxed mb-3" style={{ fontWeight: 320 }}>
                      Lets Serverless Dashboard <strong style={{ fontWeight: 540 }}>read and write files</strong> in your repos.
                      Without this, the app can't load or save your JSON config.
                    </p>
                    <div className="rounded-xl overflow-hidden border border-black/10">
                      <img src={imgAddRepoRules} alt="Select repo scope checkbox in GitHub token settings" className="w-full h-auto" loading="lazy" decoding="async" />
                    </div>
                  </div>
                  <div className="bg-white/70 rounded-2xl p-5 border border-black/10">
                    <div className="flex items-center gap-2.5 mb-3">
                      <div className="w-8 h-8 rounded-lg bg-black/10 flex items-center justify-center">
                        <UserCircle className="w-4 h-4 text-black" aria-hidden="true" />
                      </div>
                      <div>
                    ...
                    <div className="rounded-xl overflow-hidden border border-black/10">
                      <img src={imgAddUserRules} alt="Select read:user scope in GitHub token settings" className="w-full h-auto" loading="lazy" decoding="async" />
                    </div>
                  </div>
                </div>
                <div className="ml-11">
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                ...
                <div className="ml-11 space-y-4">
                  ...
                  <p className="body-sm text-black/70 leading-relaxed" style={{ fontWeight: 320 }}>
                    Go back to the <strong style={{ fontWeight: 540 }}>Serverless Dashboard login page</strong> and paste the token into the <strong style={{ fontWeight: 540 }}>Authorization</strong> field.
                  </p>
                  <div className="p-4 rounded-2xl bg-white/70 border border-black/10 body-sm text-black/60" style={{ fontWeight: 320 }}>
                    <span role="img" aria-label="Lock icon">🔒</span> <strong style={{ fontWeight: 540 }}>Your token stays on your device.</strong> Serverless Dashboard stores it only in your browser's localStorage and sends it directly to GitHub's API. We never see it.
                  </div>
                  <StepImage src={imgCopyToken} alt="Copy generated GitHub token" />
                </div>
              </motion.div>
            </div>
            ...
            <div className="mt-20 text-center">
              ...
              <h2 className="display-lg text-black mb-4" style={{ fontSize: 36 }}>You're all set!</h2>
        ...
        <section className="section-gap py-20 text-center" aria-labelledby="support-heading">
          <div className="w-14 h-14 rounded-2xl bg-[#f5f5f5] flex items-center justify-center mx-auto mb-6">
            <HelpCircle className="w-7 h-7 text-black" aria-hidden="true" />
          </div>
          <h2 id="support-heading" className="display-lg text-black mb-4" style={{ fontSize: 36 }}>Still stuck?</h2>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer"
              ...
              <Github className="w-4 h-4" aria-hidden="true" /> View GitHub repo
            </a>
            <a href="mailto:support@Serverless Dashboard" className="btn-secondary border border-[#e5e5e5] inline-flex gap-2">
              Contact support <ExternalLink className="w-4 h-4" aria-hidden="true" />
            </a>
          </div>
        </section>
      </div>
