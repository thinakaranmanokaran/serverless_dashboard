...
const faqs = [
  {
    q: "What permissions does Serverless Dashboard need?",
  ...
  },
  {
    ...
    a: "Never. Serverless Dashboard is a static, client-side app. Your token lives only in your browser's localStorage and is sent directly to GitHub's API. We have no server that ever touches it."
  },
  {
...
export function Home() {
  ...
  return (
    <>
      <SEO
        title="GitHub-Native Serverless Dashboarduration for Developers"
        description="Manage your app's production configuration in real-time directly from GitHub. No servers, no lock-in. Feature flags, JSON config, instant updates. Free forever."
        keywords="Serverless Dashboard, Serverless Dashboarduration, github config management, feature flags, json configuration, serverless config, developer tools, production config, github personal access token, Serverless Dashboardashboard, config management tool"
        canonical="/"
        ogType="website"
        jsonLd={faqSchema}
      />
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <section className="color-block color-block-lime section-gap" aria-labelledby="how-it-works-heading">
          <div className="max-w-2xl">
            <p className="eyebrow text-black/50 mb-4">How it works</p>
            <h2 id="how-it-works-heading" className="display-lg text-black mb-8">
            ...
            <p className="subhead text-black/70 mb-10" style={{ fontWeight: 330 }}>
              ...
              Serverless Dashboard reads and writes them via the GitHub API - giving you
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-10">
              {[
                ...
                <div key={n} className="bg-white/60 rounded-2xl p-6">
                  ...
                  <h3 className="headline text-black mb-2" style={{ fontSize: 18, fontWeight: 540 }}>{title}</h3>
        ...
        <section className="section-gap" aria-labelledby="features-heading">
          <p className="eyebrow text-[#737373] mb-4">Core capabilities</p>
          <h2 id="features-heading" className="display-lg text-black mb-14">
        ...
        <section className="color-block color-block-navy section-gap" aria-labelledby="feature-flags-heading">
          <div className="max-w-2xl">
            <p className="eyebrow text-white/40 mb-6">Feature flagging</p>
            <h2 id="feature-flags-heading" className="display-lg text-white mb-6">
        ...
        <section className="color-block color-block-coral section-gap" aria-labelledby="integration-heading">
          <div className="max-w-2xl">
            <p className="eyebrow text-black/50 mb-4">Integration</p>
            <h2 id="integration-heading" className="display-lg text-black mb-6">
            ...
            <div className="bg-black rounded-2xl p-6 font-mono text-sm text-white mb-8 overflow-x-auto" role="feed" aria-label="Code example">
        ...
        <section className="color-block color-block-lime section-gap" aria-labelledby="faq-heading">
          <div className="max-w-3xl mx-auto">
            <p className="eyebrow text-black/50 text-center mb-4">FAQ</p>
            <h2 id="faq-heading" className="display-lg text-black text-center mb-12">
              Common questions.
            </h2>
        ...
        <section className="section-gap text-center py-20" aria-labelledby="cta-heading">
          <p className="eyebrow text-[#737373] mb-6">Ready?</p>
          <h2 id="cta-heading" className="display-lg text-black mb-6 mx-auto">
